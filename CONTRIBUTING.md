...
We use [Codeberg Issues](https://codeberg.org/projectfile/cli/issues) to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://codeberg.org/projectfile/cli/issues/new). (Since we can’t be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
- Perform a [search](https://codeberg.org/projectfile/cli/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project.

<!-- omit in toc -->
### How Do I Submit a Good Enhancement Suggestion?

Enhancement suggestions are tracked as [Codeberg Issues](https://codeberg.org/projectfile/cli/issues).
