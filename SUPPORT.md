...
Thanks for using **Projectfile CLI**!
...
- [Issues on GitHub](https://github.com/projectfile-org/cli/issues)
...
4. **Environment** — OS, version of Projectfile CLI, runtime version.
...
Paid support for Projectfile CLI is available:
